...
The `oxcgrt` package includes two types of functions. First are functions that retrieve data via [OxCGRT](https://www.bsg.ox.ac.uk/covidtracker)'s API, and second are function that calculate [OxCGRT](https://www.bsg.ox.ac.uk/covidtracker)'s various indices.
